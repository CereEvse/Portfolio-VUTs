...
public class StudentStatusService {
    ...
    public void recalculateStatus(Student student) {
        ...
        if (/*student.getMedicalResult() == null || */student.getPsychoCategory() == null) {
            student.setStatus(StudentStatus.APPLIED);
            return;
        }

//        boolean medicalOk = student.getMedicalResult() == Student.MedicalResult.GODEN;
        ...
        if (/*!medicalOk || */!psychoOk || !physicalOk || !academicOk) {
